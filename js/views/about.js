...
const VERSION_HISTORY = [
  {
    ...
    changes: [
      ...
      'Share results via Web Share API / clipboard',
  ...
  },
  {
    ...
    date: '2026-03-07',
    changes: [
      'Virtual supporter Sakura (Hakata dialect, toggleable)',
...
registerRoute('#about', (app) => {
  ...
  h1.appendChild(trNode('about.title', 'About BrokerPass SG'));
  app.appendChild(h1);
  ...
  disclaimerText.innerHTML = [
    ...
    '\u203B Sakura\u306E\u535A\u591A\u5F01\u306F\u958B\u767A\u8005\u306E\u8DA3\u5473\u3067\u3042\u308A\u3001SCI\u8A66\u9A13\u3068\u306F\u4E00\u5207\u95A2\u4FC2\u3042\u308A\u307E\u305B\u3093\u3002',
