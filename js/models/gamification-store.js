...
const ACHIEVEMENTS = [
  { id: 'first_quiz', name: 'First Steps', nameJA: 'はじめの一歩', desc: 'Complete your first quiz', icon: '\uD83D\uDC63', check: (g) => g.totalQuizzes >= 1 },
  { id: 'ten_quizzes', name: 'Getting Started', nameJA: 'スタートダッシュ', desc: 'Complete 10 quizzes', icon: '\uD83D\uDCDA', check: (g) => g.totalQuizzes >= 10 },
  { id: 'fifty_quizzes', name: 'Dedicated', nameJA: '努力家', desc: 'Complete 50 quizzes', icon: '\uD83C\uDFC5', check: (g) => g.totalQuizzes >= 50 },
  { id: 'streak_5', name: 'Hot Streak', nameJA: '絶好調', desc: '5 correct answers in a row', icon: '\uD83D\uDD25', check: (g) => g.bestStreak >= 5 },
  { id: 'streak_10', name: 'Unstoppable', nameJA: '止まらない', desc: '10 correct answers in a row', icon: '\u26A1', check: (g) => g.bestStreak >= 10 },
  { id: 'streak_20', name: 'Machine', nameJA: 'マシーン', desc: '20 correct answers in a row', icon: '\uD83E\uDD16', check: (g) => g.bestStreak >= 20 },
  { id: 'perfect_10', name: 'Perfect 10', nameJA: 'パーフェクト', desc: 'Score 100% on a 10-question quiz', icon: '\uD83D\uDCAF', check: (g) => g.perfectQuizzes >= 1 },
  { id: 'mock_pass', name: 'Exam Ready', nameJA: '試験準備OK', desc: 'Pass a mock exam (70%+)', icon: '\uD83C\uDF93', check: (g) => g.mockPasses >= 1 },
  { id: 'mock_ace', name: 'Ace', nameJA: 'エース', desc: 'Score 90%+ on a mock exam', icon: '\uD83C\uDFC6', check: (g) => g.mockAces >= 1 },
  { id: 'both_modules', name: 'Well-Rounded', nameJA: 'オールラウンダー', desc: 'Practice all 4 modules', icon: '\uD83C\uDF0F', check: (g) => g.bcpAttempts > 0 && g.comgiAttempts > 0 && (g.pgiAttempts || 0) > 0 && (g.hiAttempts || 0) > 0 },
  { id: 'five_topics', name: 'Explorer', nameJA: '探検家', desc: 'Master 5 topics', icon: '\uD83D\uDDFA\uFE0F', check: (g) => g.topicsMastered >= 5 },
  { id: 'fifteen_topics', name: 'Specialist', nameJA: 'スペシャリスト', desc: 'Master 15 topics', icon: '\uD83C\uDFAF', check: (g) => g.topicsMastered >= 15 },
  { id: 'all_topics', name: 'Completionist', nameJA: 'コンプリート', desc: 'Master all topics', icon: '\u2B50', check: (g) => g.topicsMastered >= (g._totalTopics || 39) },
