...
const DEFAULTS = {
  ...
  supporterEnabled: true,   // Always on (setting toggle removed — Sakura is mandatory)
  // Home screen section visibility
  homeShowXp: true,
  homeShowGoal: true,
  homeShowStats: true,
  // homeShowCountdown removed — date badges always show
  homeShowTrivia: true,
  arrivalDate: '',            // SG arrival date (YYYY-MM-DD), set by user
  examDate: '',              // Exam date (YYYY-MM-DD), set by user
  extraModules: true,       // PGI & HI modules always enabled
