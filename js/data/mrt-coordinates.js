...
export const NS_COORDS = [
  ...
  { code: 'NS23', name: 'Somerset', x: 323, y: 322 },
  ...
  { code: 'NS27', name: 'Marina Bay', x: 420, y: 477, interchange: ['CE2', 'TE20'] },
...
export const EW_COORDS = [
  ...
  { code: 'EW6', name: 'Kembangan', x: 594, y: 247 },
  { code: 'EW7', name: 'Eunos', x: 571, y: 269 },
  { code: 'EW8', name: 'Paya Lebar', x: 536, y: 296, interchange: ['CC9'] },
  { code: 'EW9', name: 'Aljunied', x: 524, y: 315 },
  { code: 'EW10', name: 'Kallang', x: 505, y: 334 },
  { code: 'EW11', name: 'Lavender', x: 486, y: 353 },
  { code: 'EW12', name: 'Bugis', x: 458, y: 371, interchange: ['DT14'] },
  ...
  { code: 'EW16', name: 'Outram Park', x: 303, y: 413, interchange: ['NE3', 'TE17'] },
  { code: 'EW17', name: 'Tiong Bahru', x: 284, y: 398 },
  { code: 'EW18', name: 'Redhill', x: 264, y: 379 },
  { code: 'EW19', name: 'Queenstown', x: 245, y: 360 },
  { code: 'EW20', name: 'Commonwealth', x: 230, y: 345 },
...
export const NE_COORDS = [
  { code: 'NE1', name: 'HarbourFront', x: 311, y: 481, interchange: ['CC29'] },
  { code: 'NE3', name: 'Outram Park', x: 319, y: 413, interchange: ['EW16', 'TE17'] },
  { code: 'NE4', name: 'Chinatown', x: 334, y: 394, interchange: ['DT19'] },
  ...
  { code: 'NE10', name: 'Potong Pasir', x: 408, y: 228 },
  { code: 'NE11', name: 'Woodleigh', x: 431, y: 205 },
  { code: 'NE12', name: 'Serangoon', x: 451, y: 183, interchange: ['CC13'] },
  { code: 'NE13', name: 'Kovan', x: 474, y: 164 },
  { code: 'NE14', name: 'Hougang', x: 493, y: 145 },
  { code: 'NE15', name: 'Buangkok', x: 513, y: 126 },
  { code: 'NE16', name: 'Sengkang', x: 528, y: 111 },
  { code: 'NE17', name: 'Punggol', x: 544, y: 96 },
];
...
export const CC_COORDS = [
  ...
  { code: 'CC4', name: 'Promenade', x: 525, y: 420, interchange: ['DT15'] },
  ...
  { code: 'CC9', name: 'Paya Lebar', x: 552, y: 296, interchange: ['EW8'] },
  ...
  { code: 'CC28', name: 'Telok Blangah', x: 273, y: 463 },
  { code: 'CC29', name: 'HarbourFront', x: 295, y: 481, interchange: ['NE1'] },
];

// Circle Extension (CE): branches from Promenade (CC4)
export const CE_COORDS = [
  { code: 'CE1', name: 'Bayfront', x: 495, y: 447, interchange: ['DT16'] },
  { code: 'CE2', name: 'Marina Bay', x: 451, y: 477, interchange: ['NS27', 'TE20'] },
];
...
export const DT_COORDS = [
  ...
  { code: 'DT14', name: 'Bugis', x: 451, y: 337, interchange: ['EW12'] },
  { code: 'DT15', name: 'Promenade', x: 518, y: 415, interchange: ['CC4'] },
  { code: 'DT16', name: 'Bayfront', x: 487, y: 441, interchange: ['CE1'] },
  { code: 'DT17', name: 'Downtown', x: 443, y: 470 },
  { code: 'DT18', name: 'Telok Ayer', x: 470, y: 458 },
  { code: 'DT19', name: 'Chinatown', x: 396, y: 440, interchange: ['NE4'] },
  { code: 'DT20', name: 'Fort Canning', x: 350, y: 394 },
  { code: 'DT21', name: 'Bencoolen', x: 342, y: 364 },
  { code: 'DT22', name: 'Jalan Besar', x: 431, y: 356 },
...
export const TE_COORDS = [
  { code: 'TE1', name: 'Woodlands North', x: 171, y: 20 },
  { code: 'TE2', name: 'Woodlands', x: 202, y: 46, interchange: ['NS9'] },
  { code: 'TE3', name: 'Woodlands South', x: 214, y: 65 },
  { code: 'TE4', name: 'Springleaf', x: 229, y: 80 },
  { code: 'TE5', name: 'Lentor', x: 245, y: 95 },
  { code: 'TE6', name: 'Mayflower', x: 261, y: 111 },
  { code: 'TE7', name: 'Bright Hill', x: 276, y: 129 },
  { code: 'TE8', name: 'Upper Thomson', x: 292, y: 160 },
  ...
  { code: 'TE17', name: 'Outram Park', x: 334, y: 413, interchange: ['EW16', 'NE3'] },
  { code: 'TE18', name: 'Maxwell', x: 350, y: 428 },
  { code: 'TE19', name: 'Shenton Way', x: 389, y: 466 },
  { code: 'TE20', name: 'Marina Bay', x: 435, y: 477, interchange: ['NS27', 'CE2'] },
  // TE21 does not exist
